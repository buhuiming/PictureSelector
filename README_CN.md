# PictureSelector 3.0
   ...
   [效果体验](https://github.com/LuckSiege/PictureSelector/raw/version_component/app/demo/demo_2023-12-17_060744_v3.11.3.apk)<br>
...
## 目录
-[最新版本](https://github.com/LuckSiege/PictureSelector/releases/tag/v3.11.3)<br>
-[如何引用](#如何引用)<br>
-[进阶使用](#进阶使用)<br>
-[权限](#权限)<br>
